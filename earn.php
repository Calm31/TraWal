...
<body style="background-image: url('assets/img/1.jpg')">>
    ...
    ?>
      ...
      <br><br><br><br>
    <h1 style="color:black">EARNINGS</h1>
    ...
    <div class="container" id="home">
                    ...
                    <div class="panel-body">
                        <div class="form">
                               <div class="form-group " >
                                    <label for="cname" class="control-label col-lg-10">Amount Earned <span class="required">*</span></label>
          ...
          var lat,lang,amount,comment,date,month,year;
            ...
            function load(address)
            {
                ...
                $('#demo').load("transfer.php?id=<?php echo $id;?>&type=EARN&amount="+amount+"&tofrom=&comment="+comment+"&lat="+lat+"&lang="+lang+"&add="+address+"&date="+date+"&month="+month+"&year="+year);
                location.reload();
            }
