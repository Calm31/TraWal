...
<body style="background-image: url('assets/img/1.jpg')">>
    ...
    ?>
      ...
      <br><br><br><br>
    <h1 style="color:black">BORROWING</h1>
    ...
    <div class="container" id="home">
                    ...
                    <div class="panel-body">
                        <div class="form">
                               <div class="form-group " >
                                    <label for="cname" class="control-label col-lg-10">Amount Borrowed <span class="required">*</span></label>
                                    <div class="col-lg-10" style="margin: 10px">
                                        <input class="form-control" id="amount" type="number" min=0 required />
                                    </div>
                                </div>
                                <div class="form-group "  >
                                    <label for="cemail" class="control-label col-lg-10"> Person Borrowed From <span class="required">*</span></label>
                                    <div class="col-lg-10" style="margin: 10px">
          ...
          var lat,lang,amount,tofrom,date,month,year;
            ...
            function load(address)
            {
                ...
                $('#demo').load("transfer.php?id=<?php echo $id;?>&type=BORROW&amount="+amount+"&tofrom="+tofrom+"&comment=&lat="+lat+"&lang="+lang+"&add="+address+"&date="+date+"&month="+month+"&year="+year);
                location.reload();
            }
