...
<body style="background-image: url('assets/img/1.jpg')">>
    ...
    ?>
      ...
      <br><br><br><br>
    <h1 style="color:black">SPENDINGS</h1>
    ...
    <div class="container" id="home">
                    ...
                    <div class="panel-body">
                        <div class="form">
                               <div class="form-group " >
                                    <label for="cname" class="control-label col-lg-10">Amount Spent <span class="required">*</span></label>
                                    <div class="col-lg-10" style="margin: 10px">
                                        <input class="form-control" id="amount" type="number" min=0 required />
                                    </div>
                                </div>
                                <div class="form-group "  >
                                    <label for="cemail" class="control-label col-lg-10"> Comments <span class="required">*</span></label>
                                    <div class="col-lg-10" style="margin: 10px">
                                        <input class="form-control" type="text" id="comments" required />
                                    </div>
                                </div>
                                <div class="form-group "  >
          ...
          var lat,lang,amount,comment,date,month,year;
            ...
            function load(address)
            {
                ...
                $('#demo').load("transfer.php?id=<?php echo $id;?>&type=SPENT&amount="+amount+"&tofrom=&comment="+comment+"&lat="+lat+"&lang="+lang+"&add="+address+"&date="+date+"&month="+month+"&year="+year);
                location.reload();
            }
